...
export interface DragStarterData extends DragData {
  plan: Plan | null;
}

export interface DragStarterResult extends DragResult {}

export class DragStarter extends DragOperation implements DragStarterData {
  plan: Plan | null;
  ...
  constructor(configData: DragStarterData) {
