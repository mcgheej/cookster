...
export interface DragMoveResourceActionResult extends DragResult {
  operation: 'delete' | 'update';
  time?: Date;
}

export class DragMoveResourceAction extends DragOperation implements DragMoveResourceActionData {
  plan: Plan | null;
  resourceLane: ResourceLane;
  resourceAction: ResourceAction;
  ...
  constructor(configData: DragMoveResourceActionData) {
    super(configData as DragData);
    this.plan = configData.plan;
    this.resourceLane = configData.resourceLane;
    this.resourceAction = configData.resourceAction;
  }
  ...
  move(props: DragMoveProps): void {
  ...
  end(props: DragEndProps): DragMoveResourceActionResult | undefined {
    this.setupDropArea(props.pointerPos);
    let time: Date | undefined = undefined;
    let operation: 'delete' | 'update' | undefined = undefined;
    ...
    if (operation === 'update' && time) {
      return { operation: 'update', time };
    }
    return undefined;
  }
