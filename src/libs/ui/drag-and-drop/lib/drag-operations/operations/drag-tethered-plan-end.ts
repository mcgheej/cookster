...
export interface DragTetheredPlanEndResult extends DragResult {
  time: Date;
}

export class DragTetheredPlanEnd extends DragOperation implements DragTetheredPlanEndData {
  plan: Plan | null;
  ...
  constructor(configData: DragTetheredPlanEndData) {
